  ...
  return (
    ...
    >
      {(formik) => {
        ...
        return (
          <>
            <div className="bg-[url('https://cdn.discordapp.com/attachments/1031605156996972574/1089873814923509790/Screen_3.png')] w-full  bg-cover sticky top-0">
              <div className="mx-20">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex items-center text-start">
                    ...
                    <Link to="/courses/add-new-course/group-session"
                      className="bg-black rounded-2xl text-white py-2 px-2  border-2 hover:-translate-y-1 hover:scale-110  duration-300"
                      type="button"
                    >
                      Group Sessions
                    </Link>
                    <Link to="/courses/add-new-course/one-on-one"
                      className=" rounded-2xl text-black border-2 border-black py-1 px-2 ml-6 hover:-translate-y-1 hover:scale-110  duration-300 "
                      type="button"
                    >
                          ...
                          {formik.values.faq.map((faq, index) => (
                            <div key={index}>
                              <div className="flex  text-start items-center">
                                ...
                                <Field
                                  className="mt-4 w-[1000px] inputShadow"
