...
function NewForm() {
  ...
  const postCourse = () => {
    const  options = {
      method: "POST",
      url: "https://shivayshaktibackend.onrender.com/course",
      headers: {
      ...
      data: {
        ...
        liveClasses: formValues.liveClasses,
        price: formValues.price,
        details: formValues.details,
        startDate: formValues.startDate,
        faq: formValues.faq,
        image: propertyImage.url,
        dayDetails: formValues.dayDetails,
      },
    };
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex items-center text-start">
                    ...
                    <Link to="/courses/add-new-course/group-session"
                      className="bg-black rounded-2xl text-white py-2 px-2  border-2"
                      type="button"
                    >
                      Group Sessions
                    </Link>
                    <Link to="/courses/add-new-course/one-on-one"
                      className=" rounded-2xl text-black border-2 border-black py-1 px-2 ml-6 "
                      type="button"
                    >
                      1 on 1 Session
                    </Link>
                      ...
                      <div className="flex flex-col gap-4">
                        <div className="flex  items-center text-start">
                          ...
                          <Field
                            ...
                            type="text"
                            className="h-10 w-80 border-2 border-gray-300 shadow-lg px-2 rounded-md"
                            id="name"
                            name="name"
                          />
                        </div>
                        ...
                        <div className="flex  items-center text-start">
                          ...
                          <Field
                            className=" h-10  shadow-lg px-2 rounded-md w-48 border-[#cdcdcd] border-2 text-gray-400"
                            name="category"
                            as="select"
                          >
                        ...
                        <div className="flex  text-start items-center">
                          ...
                          <Field
                            className="h-10 text-gray-400 rounded-md w-48"
                            name="startDate"
                        ...
                        <div className="flex  text-start items-center">
                          ...
                          <Field
                            className="h-10 rounded-md w-48  border-[#cdcdcd] border-2"
                            name="batchSize"
                        ...
                        <div className="flex  text-start items-center">
                          ...
                          <Field
                            className="h-10 text-gray-400 rounded-md border-[#cdcdcd] border-2 w-48"
                            name="duration"
                            as="select"
                          >
                        ...
                        <div className="flex  text-start items-center">
                          ...
                          <Field
                            className="h-10 rounded-md text-gray-400 border-[#cdcdcd] border-2 w-48"
                            name="timings"
                      ...
                      <div>
                        <div className="flex flex-col gap-4">
                          <div className="flex  text-start items-start">
                            ...
                            <Field
                              rows="10"
                              className="w-[550px] rounded-md py-2 px-4 border-[#cdcdcd] border-2"
                              name="details"
                          ...
                          {formik.values.faq.map((faq, index) => (
                            <div key={index}>
                              ...
                              <div className="flex  text-start items-center">
                                ...
                                <Field
                                  rows="3"
                                  className="w-[1000px] rounded-md py-2 px-4 mt-4 border-[#cdcdcd] border-2"
                                  as="textarea"
